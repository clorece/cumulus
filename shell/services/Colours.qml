...
Singleton {
    ...
    // --- Redesign "matte" skin derived tokens (mirror the design's CSS vars) ---
    readonly property color accent: palette.m3primary                                      // --accent
    readonly property color accentSoft: mixColour(palette.m3primary, "#ffffff", 0.35)      // --accent-soft
    readonly property color accentInk: palette.m3onPrimary                                 // --accent-ink
    readonly property color accent2: palette.m3tertiary                                    // --accent2
    // bar pills sit one surface step brighter than the bar island (barIsland),
    // so they read as raised bubbles on the strip rather than cutouts
    readonly property color bubbleTop: palette.m3surfaceContainerHighest                   // --card-light
    readonly property color bubbleBottom: palette.m3surfaceContainerHigh                   // --card-dark
    readonly property color barIsland: palette.m3surfaceContainerLow
    readonly property color bubbleAccentTop: mixColour(palette.m3surfaceContainerHighest, palette.m3primary, 0.30)  // --hi (top)
    readonly property color bubbleAccentBottom: mixColour(palette.m3surfaceContainerHigh, palette.m3primary, 0.30)   // --hi (bottom)
