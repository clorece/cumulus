...
Bubble {
    ...
    // matte skin: buttons get the lit gradient (derived from their fill colour)
    // plus a soft ambient-occlusion shadow; Text buttons keep a transparent
    // fill and cast nothing (Bubble skips the shadow for transparent fills)
    autoFill: false
    level: 1
