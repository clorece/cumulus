...
// matte pill — a plain Bubble now that the numbers-only layout is fixed-size
// (nothing overflows, so no clipping rect): gradient + ambient-occlusion
// shadow come from the shared recipe like every other bar pill
Bubble {
    id: root
