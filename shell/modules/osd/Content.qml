...
Item {
    ...
    // matte skin: floating island background grouping the sliders
    Bubble {
        anchors.fill: parent
        z: -1
    ...
    ColumnLayout {
        ...
        anchors.horizontalCenterOffset: 0 // matte skin: no border to offset against
