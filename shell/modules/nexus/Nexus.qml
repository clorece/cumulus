...
Item {
    ...
    // matte skin: kill the nexus blob; the modal is one matte island (below)
    property color blobColour: "transparent"
    ...
    // matte skin: floating matte island background for the whole nexus modal
    Bubble {
        anchors.fill: parent
        z: -1
